...
If the command above doesn't return anything you most likely have wrong file permissions . So you first need to fix that.  
...
Also make sure your webserver and/ or proxy have a high enough upload limit. (`client_max_body_size`)

In some rare cases the error can also be caused by wrong file permission. At the top of this page you can find instructions on how to fix the permissions.
