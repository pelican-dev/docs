...
<details>
    ...
    * `SSL: no alternative certificate subject name matches target host name '_______'`: The used SSL certificate for your panel isn't valid for your panel domain, see [this guide](./panel/advanced/ssl) for creating a new SSL certificate.
...
<details>
    ...
    * `open /etc/letsencrypt/live/_____________/fullchain.pem: no such file or directory`: The SSL certificate for wings is missing, see [this guide](./panel/advanced/ssl) for creating an SSL certificate.
