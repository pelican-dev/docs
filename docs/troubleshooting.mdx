...
* `ErrorException: file_put_contents: failed to open stream: Permission denied`: wrong file permissions/ ownership for the panel files
* `Connection timed out after 5001 miliseconds for _____`: your panel can't reach wings - see the wings connections issues steps below
