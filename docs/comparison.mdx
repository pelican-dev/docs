...
<Tabs>
    <TabItem value="1" label="General">
        * ![In Progress](https://img.shields.io/badge/In_Progress-orange) First party Plugins & Themes
    ...
    <TabItem value="2" label="Frontend">
        * ![Done](https://img.shields.io/badge/Done-green) Localized Frontend
    ...
    <TabItem value="8" label="Eggs">
        * ![Done](https://img.shields.io/badge/Done-green) Easier Egg installing
