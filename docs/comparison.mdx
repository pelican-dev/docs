...
<Tabs>
    ...
    <TabItem value="5" label="Setup">
        * ![Done](https://img.shields.io/badge/Done-green) Egg selection during install
    ...
    <TabItem value="8" label="Eggs">
        ...
        * ![Done](https://img.shields.io/badge/Done-green) Change Egg format to YAML
...
- These values are not constantly updated and the other software may have implemented some of the features marked with a cross in their latest version.
