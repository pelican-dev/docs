...
### Author
This is the original creators email. 
...
As mentioned above, there is a unique `Copy Settings From` dropdown when adding a new egg. This is used in two diffrent places, there is one for the Process Managment and one for the Install Script. This gives you the ability to, as the name suggests, copy settings defined above from a different egg.
