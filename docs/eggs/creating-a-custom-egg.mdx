...
### Docker Images
Every egg has a Docker image. Images can be custom made, and you can learn how to create them in the "Creating a Custom Docker Image" guide. They have two fields that need to be defined: the name of the image and the URL where the image is hosted.  
