...
# Introduction
:::warning[Using Pelican in Production Environments]
**Pelican is in active development.** Do not run this in production environments!
Stability is not guaranteed, as Pelican may cause data corruption to your servers, and could even take your system down in a worst case scenario.

**You have been warned.** Report issues immediately.
:::
...
Pelican is developed and released under [AGPLv3](https://www.gnu.org/licenses/agpl-3.0.en.html), an open source license;
Wings is also open source, licensed under [MIT](https://opensource.org/license/mit)!
