...
A brief guide on how to upgrade PHP to the latest supported version.

Please reference the table below to check what PHP version you need for your version of Pelican.
