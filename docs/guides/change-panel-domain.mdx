...
<Tabs groupId="webserver">
    <TabItem value="nginx" label="Nginx">
        ...
        :::info[Using HTTPS?]
            If you're using HTTPS, remember to also change the SSL paths in the config file to match your new domain and [generate a new certificate](../panel/advanced/ssl).
        :::
    </TabItem>
