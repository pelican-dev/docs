...
<Admonition type="warning">
    Mounts cannot be mounted to or inside of `/home/container` or any subdirectory of it by default, you can allow it by setting `BlockBaseDirMount` to false in the Wings configuration.
</Admonition>
