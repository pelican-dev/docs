    ...
    <TabItem value="nginx" label="Nginx">
        ...
        <Tabs>
            <TabItem value="ahttps" label="https">
                ...
                ```nginx copy {5,11,25-26} title="/etc/nginx/sites-available/pelican.conf"
                server_tokens off;
            ...
            <TabItem value="bhttp" label="http">
                ```nginx copy {3} title="/etc/nginx/sites-available/pelican.conf"
                server {
                    listen 80;
                    server_name <domain>;
    ...
    <TabItem value="apache" label="Apache">
        ...
        <Tabs>
            <TabItem value="chttps" label="https">
                ...
                ```apacheconf copy {2,10,24-25} title="/etc/apache2/sites-available/pelican.conf"
                    <VirtualHost *:80>
                        ServerName <domain>
            ...
            <TabItem value="dhttp" label="http">
                ```apacheconf copy {2} title="/etc/apache2/sites-available/pelican.conf"
                    <VirtualHost *:80>
                        ServerName <domain>
                        DocumentRoot "/var/www/pelican/public"
    ...
    The config file path is `/etc/caddy/`.  
        ...
        <Tabs>
            <TabItem value="ehttps" label="https">
                ...
                ``` copy {9} title="/etc/caddy/Caddyfile"
                {
                    servers :443 {
                        timeouts {
                            read_body 120s
