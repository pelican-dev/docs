...
In your `plugin.json` you can specify an `update_url` that is fetched when checking for plugin updates. It needs to point directly to a json file with the following format:
