...
applied assuming that you've already configured the webservers to use SSL as instructed in the [web server configuration step](../panel/standalone#webserver-configuration).
