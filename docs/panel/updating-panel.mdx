...
| Panel Version | Daemon Version | Supported | PHP Version  |
| :-----------: | :------------: | :-------: | :----------: |
| 3.x           | 3.x            | ✅︎        | 8.2          |
...
After you've downloaded all of the new files you will need to update the core components of the panel. To do this,
...
<Tabs className="unique-tabs">
    ...
    <TabItem value="Rockey Linux NGINX">
    ```sh copy 
    chown -R nginx:nginx /var/www/pelican/* 
    ```
    </TabItem>
    <TabItem value="Rockey Linux Apaches">
    ```sh copy 
