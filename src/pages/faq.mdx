...
<Tabs groupId="faq" queryString>
    ...
    <TabItem label="Plugins" value="plugins">
        ...
        <details>
            ...
            Pretty much anything you want! They can add new pages, change existing ones (to some extend), add new languages, change the theme (color/ font/ css) and more.
        ...
        <details>
            ...
            You can find to official plugin repo [here](https://github.com/pelican-dev/plugins).
        </details>
    </TabItem>
</Tabs>
