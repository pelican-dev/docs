...
:::info[When is the beta?]
    ...
    **Head over to the [Install docs](/docs/install) and try out Pelican yourself.**
:::
...
<Tabs groupId="faq" queryString>
    ...
    <TabItem label="Plugins" value="plugins">
        ...
        <details>
            ...
            You can find information on that [here](./docs/plugins#install-a-plugin).
        </details>
        <details>
            <summary>How do you create plugins?</summary>

            You can find detailed information on that [here](./docs/plugins#create-a-plugin).
        </details>
        <details>
