...
This software will not work on Windows OS
</Callout>
...
|                  |**22.04**|     ✅︎    | Documentation written assuming Ubuntu 18.04 as the base OS. |
|                  | 24.04   |     ✅︎    |                                                             |
| **Rocky Linux**  | 9       |     ✅︎    |                                                             |
| **Debian**       | 11      |     ✅︎    |                                                             |
|                  | 12      |     ✅︎    |                                                             |
...
See [Creating SSL Certificates](/tutorials/creating_ssl_certificates.html) documentation page for how to create these certificates before continuing.
</Callout>
